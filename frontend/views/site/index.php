		...
		<nav id="menu-nav-wrap">
	   	...
	   	<h3>POS-Hebat.</h3>  
			...
			<ul class="nav-list">
				...
				<li><a class="smoothscroll" href="http://localhost/posyii2/backend/web/index.php?r=site%2Flogin" title="">Login</a></li>						
			</ul>	
		   ...
		   <div class="home-content-tablecell">
		   	<div class="row">
		   		<div class="col-twelve">		   			
			  				...
			  				<h3 class="animate-intro">POS-Hebat.</h3>
				  			<h1 class="animate-intro">
							Pembayaran Toko Anda  <br>
							Serahkan Kepada Kami.
				  			</h1>	

				  			<div class="more animate-intro">
				  				<a class="smoothscroll button stroke" href="http://localhost/posyii2/BACKEND/web/index.php?r=site%2Flogin">
				  					Learn More
				  				</a>
				  			</div>							
   		...
   		<div class="col-full">
   			...
   			<div class="about-profile-bg"></div>
				...
				<div class="intro">
	   			...
	   			<p class="lead animate-this"><span>POS-Hebat</span> is a creative digital agency based in Manila, Philippines. We are composed of creative designers and experienced developers.</p>	
				</div>   
